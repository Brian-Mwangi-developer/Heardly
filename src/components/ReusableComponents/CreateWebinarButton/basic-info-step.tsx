    ...
    return (
        <div className='space-y-6'>
            <div className='space-y-2'>
                ...
                />
                {errors.webinarName && (
                    <p className='text-sm text-red-4000'>{errors.webinarName}</p>
                )}
            </div>
            <div className='space-y-2'>
                <Label
                ...
                <Textarea
                    ...
                    value={description || ''}
                    onChange={handleChange}
                    placeholder='Tell us what your webinar is about'
                    className={cn('!bg-background/50 border border-input min-h-[100px]',
                        errors.description && 'border-red-400 focus-visible:ring-red-400'
                    )}
                />
                {errors.description && (
                    <p className='text-sm text-red-4000'>{errors.description}</p>
                )}
            </div>
